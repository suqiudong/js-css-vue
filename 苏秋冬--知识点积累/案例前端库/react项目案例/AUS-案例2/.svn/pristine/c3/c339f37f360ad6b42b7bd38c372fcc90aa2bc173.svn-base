...
! function() {
  ...
  function set_canvas_size() {
    canvas_width = the_canvas.width = ele.clientWidth || window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth,
    canvas_height = the_canvas.height = ele.clientHeight || window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight;
  }
  ...
  let ele = document.getElementById('flash');
  ele.appendChild(the_canvas);
